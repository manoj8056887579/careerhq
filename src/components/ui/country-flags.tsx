...
export default function DomeGallery({
  ...
  const openItemFromElement = (el: HTMLElement) => {
    ...
    if (rawAlt) {
      ...
      nameOverlay.style.cssText = `position:absolute; bottom:0; left:0; right:0; padding:16px; background:linear-gradient(to top, rgba(0,0,0,0.9), transparent); pointer-events:none;`;
      const nameText = document.createElement("span");
      nameText.textContent = rawAlt;
      nameText.style.cssText = `color:white; font-weight:bold; font-size:20px; display:block; text-align:center; text-shadow:0 2px 4px rgba(0,0,0,0.5);`;
            ...
            <div ref={sphereRef} className="sphere">
              {items
                ...
                .map((it, i) => (
                  ...
                  >
                    <div
                      className="item__image absolute block overflow-hidden cursor-pointer bg-transparent transition-transform duration-300 group"
                      role="button"
                      tabIndex={0}
